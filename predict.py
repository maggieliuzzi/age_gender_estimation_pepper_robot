...
# If the file is run directly, it can make a prediction against one image
...
if __name__ == "__main__":
    '''If predict.py is run directly, it makes a prediction for an image from a file'''
    ...
    raw_prediction = predict_from_file(model, args.pic)
    print("\nProbability of [1-15,16-30,31-45,46-60]: " + str(raw_prediction))
    exit(0)