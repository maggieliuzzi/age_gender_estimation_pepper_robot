...
train_path = os.path.join(home_path, "dataset_adience_age_6_ED_bins/train")
validate_path = os.path.join(home_path, "dataset_adience_age_6_ED_bins/validate")
test_path = os.path.join(home_path, "dataset_adience_age_6_ED_bins/test")
...
model_new.save('final_model_adience_age_6_ED_bins.h5')