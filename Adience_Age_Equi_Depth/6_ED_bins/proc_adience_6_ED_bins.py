...
csv_path = "/Users/maggieliuzzi/NeuralNetworks/Adience/adience_age_6_ED_bins.csv"
zip_path = "/Users/maggieliuzzi/NeuralNetworks/adience.zip"
source_path = '/Users/maggieliuzzi/NeuralNetworks/Adience/'
dataset_path = os.path.join(home_path, "dataset_adience_age_6_ED_bins")

train_path = os.path.join(dataset_path, "train")
validate_path = os.path.join(dataset_path, "validate")
test_path = os.path.join(dataset_path, "test", "test")

train_path_0 = os.path.join(train_path, "1-7") # bin1
train_path_1 = os.path.join(train_path, "8-16") # bin2
train_path_2 = os.path.join(train_path, "17-27") # bin3
train_path_3 = os.path.join(train_path, "28") # bin4 # 3992 rows
train_path_4 = os.path.join(train_path, "29-41") # bin5
train_path_5 = os.path.join(train_path, "42-60") # bin6

validate_path_0 = os.path.join(validate_path, "1-7")
validate_path_1 = os.path.join(validate_path, "8-16")
validate_path_2 = os.path.join(validate_path, "17-27")
validate_path_3 = os.path.join(validate_path, "28")
validate_path_4 = os.path.join(validate_path, "29-41")
validate_path_5 = os.path.join(validate_path, "42-60")
...
with open(csv_path) as csvfile:
    ...
    for i in range(0, train_images):
        ...
        # print(source)
        destination = os.path.join(home_path, "dataset_adience_age_6_ED_bins", "train", bin)
        print(destination)
    ...
    for i in range(train_images, train_images + validate_images):
        ...
        source = os.path.join(source_path, filepath)
        # print(source)
        destination = os.path.join(home_path, "dataset_adience_age_6_ED_bins", "validate", bin)
        print(destination)
        shutil.copy(source, destination)
        file.write(str(usable_age[i]) + '\n')
        current_point += 1
    ...
    for i in range(train_images + validate_images, good_images):
        ...
        source = os.path.join(source_path, filepath)
        # print(source)
        destination = os.path.join(home_path, "dataset_adience_age_6_ED_bins", "test", "test")
        print(destination)
        shutil.copy(source, destination)
        file.write(str(usable_age[i]) + '\n')
        current_point += 1
