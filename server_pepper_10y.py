...
def predict():
    ...
    if flask.request.files.get("image"):
        ...
        # age
        midpoints = [5.5, 15.5, 25.5, 35.5, 45.5, 55.5]
        ...
        data["prediction_age"] = {"1-10": float(raw_prediction_age[0]), "11-20": float(raw_prediction_age[1]), "21-30": float(raw_prediction_age[2]),
                              "31-40": float(raw_prediction_age[3]), "41-50": float(raw_prediction_age[4]), "51-60": float(raw_prediction_age[5]), "Estimate": calculated_age}
        # gender
